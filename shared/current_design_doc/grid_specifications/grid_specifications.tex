...
\begin{figure}[htb]
\begin{center}
\subfigure[Planar Voronoi tessellation]{\includegraphics[scale=0.4]{figures/planar_vt.png}}
\subfigure[Spherical Voronoi tessellation]{\includegraphics[scale=0.4]{figures/spherical_vt.png}}
